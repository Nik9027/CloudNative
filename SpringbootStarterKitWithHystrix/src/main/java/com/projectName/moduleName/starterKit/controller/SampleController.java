...
import com.projectName.moduleName.starterKit.restTemplate.CallApiUsingHystrix;
...
public class SampleController {
	...
	@Autowired
	CallApiUsingHystrix callApiUsingHystrix;
/*	@Autowired
...
*/	
	...
	@RequestMapping(value="/restHystrixCall", method = RequestMethod.GET)
	public String getRestCallwithHystrix() {
		
		return callApiUsingHystrix.CallHelloWorldAPI();
	}
